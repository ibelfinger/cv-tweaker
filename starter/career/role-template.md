# [Company] — [Title]
[Location] · [YYYY-MM] – [YYYY-MM] · [Reporting line] · [Team size / scope]
...
## Context
What the org is, its scale, the business, your mandate.

## What I owned
Teams, domains, budgets, surfaces, products.

## Initiatives
### [Initiative name]
- Situation / problem
- What I did (decisions, approach, leadership moves)
- Tools & methods used
- Outcome with hard metrics

## Metrics bank
Every quantified result, raw and reusable (before/after, %, $, throughput, time).

## Tools, systems & domain
Concrete tools, platforms, methods, and domain knowledge.
...
## CV handling note
Anything specific about how this role should (or should not) appear on a CV.
